 ...
 -->
                ...
                <div class="login_form l_float">
                    <div class="login_top">
                        ...
                        <div class="login_tags b_clear">
                             <span class="top_tag l_float active" onClick="PwdLogin()">账号注册</span>  
	...
	%>
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="password" value="<%= request.getParameter("username") == null ? "" : request.getParameter("password") %>">
                       ...
                       <!--     <div  class="b_clear">
                            ...
                            <div class="b_clear submit">
                                ...
                                <button type="submit" value="Submit">注&nbsp;&nbsp;册</button>
