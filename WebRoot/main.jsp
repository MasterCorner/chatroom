...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临在线聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临在线聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
...
<body>
	<div margin-left:auto; margin-right:auto; width:168px;>
