		...
		<table width="371" height="230" border="0" align="center" cellpadding="0" cellspacing="0" background="images/login.jpg">
			...
			<tr>
				...
				<table width="100%" height="100%">
						<tr>
							<td>验证码：</td>
							<td><input type="text" name="auth_code" class="login"></td>   
                            <td><img style="width:60px;height:30px;margin-left:50px" alt="" src="<%= request.getContextPath() %>/ValidateColorServlet"></td>
						</tr>
					</table>
				</td>
				<td width="94" valign="top" class="word_dark"></td>
